        ...
        */
        'default' => [
            'api' => [
                ...
                |--------------------------------------------------------------------------
                */
                'title' => 'Hocool Web Application Documenation UI',
            ],
            'routes' => [
                /*
                |--------------------------------------------------------------------------
        ...
        'mobile' => [
            'api' => [
                ...
                |--------------------------------------------------------------------------
                */
                'title' => 'Hocool Mobile API Documentation UI',
            ],
            'routes' => [
                /*
                |--------------------------------------------------------------------------
                ...
                */
                ...
                'oauth2_callback' => "vendor/swaggervel/oauth2-redirect.html",
    ...
    'security' => [
        ...
        */
        ...
        'oauth2_security_example' => [ // Unique name of security
            ...
            'tokenUrl' => '/api/jwtToken', // The authorization URL to be used for (password/application/accessCode)
            'scopes' => []
        ],
